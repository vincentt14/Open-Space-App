...
//  - should return the talks with new talk when given by ADD_TALK action;
//  - should return the talks with the toggled like talk when given by TOGGLE_TALK action;

describe('talkReducer functions', () => {
